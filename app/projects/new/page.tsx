  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,_#f6faf8_0%,_#eef4f1_100%)] px-6 py-8 text-zinc-950 dark:bg-[linear-gradient(180deg,_#09090b_0%,_#111827_100%)] dark:text-zinc-50">
      ...
      >
        <Suspense
          fallback={
            <div className="cf-motion-loading-state rounded-[24px] border border-dashed border-zinc-300 bg-white/80 px-6 py-10 text-sm text-zinc-600 dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-zinc-300">
