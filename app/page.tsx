      ...
      <section className="mx-auto grid min-h-[calc(100vh-10rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div>
          ...
          <h1 className="mt-6 max-w-3xl text-4xl font-semibold tracking-tight sm:text-6xl">
            Sign in to manage your AI QA workspace.
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <SignUpButton>
              <button className="rounded-xl bg-[linear-gradient(135deg,_#06b6d4_0%,_#2563eb_52%,_#7c3aed_100%)] px-5 py-3 text-sm font-extrabold text-white shadow-[0_18px_45px_-25px_rgba(37,99,235,0.9)] transition hover:-translate-y-0.5 hover:brightness-110">
                Sign Up
              </button>
            </SignUpButton>
          </div>
