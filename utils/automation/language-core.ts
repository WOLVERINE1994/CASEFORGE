...
export const AUTOMATION_COMMAND_CATALOG: AutomationCommandDefinition[] = [
  ...
  command("salesforceOpenSetup", "Open Salesforce Setup", [param("setupArea", "string", {
    description: "Setup area or direct setup path, for example Object Manager, Users, Flows, or Profiles.",
    required: false,
  })], {
    aliases: ["Navigate Setup", "Open Setup Home", "Open Salesforce admin setup"],
    category: "enterprise.salesforce.setup",
    description: "Open Salesforce Setup before validating admin configuration.",
    domain: "enterprise",
    executable: false,
    runtimeHandler: "enterprise.salesforce.setup.open",
  }),
  command("salesforceSearchSetup", "Search Salesforce Setup Quick Find", [param("setupItem", "string", {
    description: "Setup menu item to find, such as Object Manager, Users, Profiles, Permission Sets, Flows, or App Manager.",
    required: true,
  })], {
    aliases: ["Use Setup Quick Find", "Find Salesforce setup page", "Search Setup"],
    category: "enterprise.salesforce.setup",
    description: "Use Setup Quick Find to reach an administrator configuration page.",
    domain: "enterprise",
    executable: false,
    runtimeHandler: "enterprise.salesforce.setup.search",
  }),
  command("salesforceOpenObjectManager", "Open Object Manager for object", [param("objectApiName", "string", {
    description: "Object API name or label, for example Account, Contact, Case, Opportunity, Lead, or a custom object.",
    required: true,
  })], {
    aliases: ["Open Salesforce Object Manager", "Open object setup", "Open object fields and relationships"],
    category: "enterprise.salesforce.objectManager",
    description: "Open Object Manager for an object before validating fields, layouts, buttons, or automation.",
    domain: "enterprise",
    executable: false,
    runtimeHandler: "enterprise.salesforce.objectManager.open",
  }),
  command("salesforceVerifyFieldConfig", "Verify Salesforce field configuration", [
    param("objectApiName", "string", { required: true }),
    param("fieldApiName", "string", { required: true }),
    param("expectedType", "string", { required: false }),
    param("expectedBehavior", "string", {
      description: "Expected admin behavior such as required, read-only, encrypted, picklist values, help text, or default value.",
      required: false,
    }),
  ], {
    aliases: ["Verify field-level configuration", "Check Salesforce field setup", "Validate field metadata"],
    category: "enterprise.salesforce.objectManager",
    description: "Verify an object's field type, requirement, help text, picklist, or field-level behavior.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.objectManager.verifyField",
    stepKind: "assertion",
  }),
  command("salesforceVerifyPageLayout", "Verify Salesforce page layout", [
    param("objectApiName", "string", { required: true }),
    param("layoutName", "string", { required: false }),
    param("expectedSections", "string", {
      description: "Expected sections, fields, buttons, related lists, or Lightning page regions.",
      required: true,
    }),
  ], {
    aliases: ["Validate Salesforce page layout", "Verify Lightning record page", "Check related lists on layout"],
    category: "enterprise.salesforce.ui",
    description: "Verify record page layout, sections, fields, buttons, and related lists.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.ui.verifyPageLayout",
    stepKind: "assertion",
  }),
  command("salesforceCreateRecord", "Create Salesforce record", [
    param("objectApiName", "string", { required: true }),
    param("fieldValues", "json", {
      description: "Record field values as JSON. Use test data variables for environment-specific values.",
      required: true,
    }),
  ], {
    aliases: ["Create record in Salesforce", "Add Salesforce record", "Create Account Contact Lead Opportunity Case"],
    category: "enterprise.salesforce.data",
    description: "Create a Salesforce record for admin validation or test data setup.",
    domain: "enterprise",
    executable: false,
    outputDefinition: { canSaveAsVariable: true, defaultOutputVariableName: "salesforce.recordId", outputType: "string" },
    runtimeHandler: "enterprise.salesforce.data.createRecord",
    stepKind: "dataSetup",
  }),
  command("salesforceUpdateRecord", "Update Salesforce record", [
    param("objectApiName", "string", { required: true }),
    param("recordLocator", "string", {
      description: "Record id, name, URL, or SOQL filter used to find the record.",
      required: true,
    }),
    param("fieldValues", "json", { required: true }),
  ], {
    aliases: ["Edit Salesforce record", "Update record field values", "Modify Salesforce data"],
    category: "enterprise.salesforce.data",
    description: "Update Salesforce record values during an admin workflow test.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.data.updateRecord",
  }),
  command("salesforceVerifyRecordField", "Verify Salesforce record field value", [
    param("objectApiName", "string", { required: true }),
    param("recordLocator", "string", { required: true }),
    param("fieldApiName", "string", { required: true }),
    param("expectedValue", "string", { required: true }),
    matchTypeParam,
  ], {
    aliases: ["Check Salesforce record field", "Validate saved record value", "Verify object field value"],
    category: "enterprise.salesforce.data",
    description: "Verify a record field value after a save, automation, import, or permission-driven action.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.data.verifyRecordField",
    stepKind: "assertion",
  }),
  command("salesforceVerifyValidationRule", "Verify Salesforce validation rule", [
    param("objectApiName", "string", { required: true }),
    param("ruleName", "string", { required: false }),
    param("invalidData", "json", {
      description: "Invalid record data that should trigger the validation rule.",
      required: true,
    }),
    param("expectedError", "string", { required: true }),
  ], {
    aliases: ["Test Salesforce validation rule", "Verify validation error", "Check required business rule"],
    category: "enterprise.salesforce.automation",
    description: "Verify validation rules block invalid data and show the expected error message.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.automation.verifyValidationRule",
    stepKind: "assertion",
  }),
  command("salesforceRunFlow", "Run Salesforce Flow", [
    param("flowName", "string", { required: true }),
    param("inputValues", "json", {
      description: "Flow input values as JSON. Leave empty for screen flows driven manually.",
      required: false,
    }),
  ], {
    aliases: ["Launch Flow", "Test Salesforce Flow", "Run screen flow"],
    category: "enterprise.salesforce.automation",
    description: "Run or launch a Salesforce Flow as part of admin automation validation.",
    domain: "enterprise",
    executable: false,
    outputDefinition: { canSaveAsVariable: true, defaultOutputVariableName: "salesforce.flowResult", outputType: "object" },
    runtimeHandler: "enterprise.salesforce.automation.runFlow",
  }),
  command("salesforceVerifyPermissionAccess", "Verify Salesforce permission access", [
    param("userAlias", "string", {
      description: "Admin-maintained user alias or test persona.",
      required: true,
    }),
    param("objectApiName", "string", { required: true }),
    param("accessExpectation", "select", {
      defaultValue: "canRead",
      options: [
        { label: "Can read", value: "canRead" },
        { label: "Can create", value: "canCreate" },
        { label: "Can edit", value: "canEdit" },
        { label: "Can delete", value: "canDelete" },
        { label: "Cannot access", value: "cannotAccess" },
        { label: "Field read-only", value: "fieldReadOnly" },
        { label: "Field hidden", value: "fieldHidden" },
      ],
      required: true,
    }),
    param("fieldApiName", "string", { required: false }),
  ], {
    aliases: ["Validate profile access", "Validate permission set access", "Check object permission", "Check field-level security"],
    category: "enterprise.salesforce.security",
    description: "Verify profile, permission set, object permission, and field-level security expectations.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.security.verifyPermissionAccess",
    stepKind: "assertion",
  }),
  command("salesforceAssignPermissionSet", "Assign Salesforce permission set", [
    param("userAlias", "string", { required: true }),
    param("permissionSetName", "string", { required: true }),
  ], {
    aliases: ["Assign permission set", "Grant Salesforce permission set", "Setup permission assignment"],
    category: "enterprise.salesforce.security",
    description: "Assign a permission set to a user as setup for role/profile validation.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.security.assignPermissionSet",
    stepKind: "dataSetup",
  }),
  command("salesforceLoginAsUser", "Login as Salesforce user", [param("userAlias", "string", {
    description: "Test user alias, persona, or username reference.",
    required: true,
  })], {
    aliases: ["Switch Salesforce user", "Login as test user", "Validate as another profile"],
    category: "enterprise.salesforce.security",
    description: "Switch to a Salesforce test user before validating persona-specific access.",
    domain: "enterprise",
    executable: false,
    runtimeHandler: "enterprise.salesforce.security.loginAsUser",
  }),
  command("salesforceRunReport", "Run Salesforce report", [
    param("reportName", "string", { required: true }),
    param("expectedResult", "string", {
      description: "Expected rows, columns, filters, totals, charts, or visibility outcome.",
      required: false,
    }),
  ], {
    aliases: ["Open Salesforce report", "Validate report visibility", "Run dashboard source report"],
    category: "enterprise.salesforce.reporting",
    description: "Run a report and verify admin reporting visibility, filters, columns, or summarized output.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.reporting.runReport",
  }),
  command("salesforceVerifyDashboard", "Verify Salesforce dashboard", [
    param("dashboardName", "string", { required: true }),
    param("expectedWidgets", "string", {
      description: "Expected charts, metrics, filters, refresh behavior, or dashboard components.",
      required: true,
    }),
  ], {
    aliases: ["Validate Salesforce dashboard", "Check dashboard components", "Verify dashboard refresh"],
    category: "enterprise.salesforce.reporting",
    description: "Verify dashboards show expected components, filters, metrics, and access behavior.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.reporting.verifyDashboard",
    stepKind: "assertion",
  }),
  command("salesforceImportData", "Import Salesforce data", [
    param("objectApiName", "string", { required: true }),
    param("sourceFile", "filePath", { required: true }),
    param("mappingName", "string", { required: false }),
  ], {
    aliases: ["Use Data Import Wizard", "Import records into Salesforce", "Validate data load"],
    category: "enterprise.salesforce.data",
    description: "Import Salesforce data and capture the import result for admin data management coverage.",
    domain: "enterprise",
    executable: false,
    outputDefinition: { canSaveAsVariable: true, defaultOutputVariableName: "salesforce.importResult", outputType: "object" },
    runtimeHandler: "enterprise.salesforce.data.importData",
    stepKind: "dataSetup",
  }),
  command("salesforceInstallAppExchangePackage", "Install AppExchange package", [
    param("packageName", "string", { required: true }),
    param("installFor", "select", {
      defaultValue: "adminsOnly",
      options: [
        { label: "Admins only", value: "adminsOnly" },
        { label: "All users", value: "allUsers" },
        { label: "Specific profiles", value: "specificProfiles" },
      ],
      required: true,
    }),
  ], {
    aliases: ["Power Up with AppExchange", "Validate AppExchange install", "Install Salesforce package"],
    category: "enterprise.salesforce.appExchange",
    description: "Represent AppExchange package installation and permission scope review.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.appExchange.installPackage",
  }),
  command("salesforceVerifySetupAuditTrail", "Verify Salesforce Setup Audit Trail", [
    param("expectedChange", "string", {
      description: "Expected setup change, user, object, field, flow, permission, package, or timestamp signal.",
      required: true,
    }),
    matchTypeParam,
  ], {
    aliases: ["Check Setup Audit Trail", "Verify admin change history", "Review Salesforce setup change"],
    category: "enterprise.salesforce.governance",
    description: "Verify admin configuration changes are visible in Setup Audit Trail for governance review.",
    domain: "enterprise",
    executable: false,
    outputDefinition: passFailOutput,
    runtimeHandler: "enterprise.salesforce.governance.verifySetupAuditTrail",
    stepKind: "assertion",
  }),
